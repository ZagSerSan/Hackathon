...
export class Message extends Module {
   ...
   trigger() {
      // функционал модуля
      function  getRandomQuote(thisQuotes) {
         // const 
         const randomIndex = Math.floor(Math.random() * thisQuotes.length);
         return thisQuotes[randomIndex];
      }

      const quote = getRandomQuote(this.quotes);
